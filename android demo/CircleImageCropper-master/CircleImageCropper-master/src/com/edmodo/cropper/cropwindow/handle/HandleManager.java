...
public class HandleManager
{
	...
	static
	{
		...
		BOTTOM_LEFT = new Handle(new CornerHandleHelper(EdgeManager.BOTTOM, EdgeManager.LEFT), HandleType.BOTTOM_LEFT);
		BOTTOM_RIGHT = new Handle(new CornerHandleHelper(EdgeManager.BOTTOM, EdgeManager.RIGHT), HandleType.BOTTOM_RIGHT);
