...
public class CropImageView extends FrameLayout {
    ...
    public Bitmap getCroppedImage() {
        ...
        final float cropWindowX = EdgeType.LEFT - displayedImageRect.left;
        final float cropWindowY = EdgeType.TOP - displayedImageRect.top;
    ...
    public RectF getActualCropRect() {
        ...
        // Get crop window position relative to the displayed image.
        final float displayedCropLeft = EdgeType.LEFT - displayedImageRect.left;
        final float displayedCropTop = EdgeType.TOP - displayedImageRect.top;
